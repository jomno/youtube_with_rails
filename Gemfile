...
gem 'rolify'
gem 'jquery-ui-rails'
# Yt makes it easy to interact with Youtube V3 API by providing a modular, intuitive and tested Ruby-style API. (http://github.com/Fullscreen/yt)
gem 'yt', '~> 0.13.7'
...
gem "figaro"
# Inspect your Rails DB (table content viewer, execute sql queries, export & import data (https://github.com/igorkasyanchuk/rails_db)
gem 'rails_db'
# Make any Ruby object quack like ActiveRecord (https://github.com/makandra/active_type)
